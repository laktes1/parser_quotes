...
def scrape_quotes(base_url='https://quotes.toscrape.com/page/', max_pages=100):
    """Собирает цитаты со всех страниц до конца или до max_pages."""
    all_quotes = []
    with requests.Session() as session:
        for i in range(1, max_pages + 1):
            ...
            all_quotes.append({'url': url, 'quotes': page_quotes})
...
if __name__ == "__main__":
    # Запуск парсинга
    try:
        quotes_data = scrape_quotes(base_url='https://quotes.toscrape.com/page/')
    ...
    try:
        ...
        print("Цитаты успешно сохранены в файл quotes.json")
